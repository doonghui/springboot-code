...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            Book book1 = creatBook("JPA1 Book", 20000, 200);
            em.persist(book1);

            Book book2 = creatBook("JPA2 Book", 40000, 300);
            em.persist(book2);
        ...
        public void dbInit2() {
            Member member = createMember("userB", "부산", "3", "11113");
            em.persist(member);
        ...
        private Book creatBook(String bookName, int price, int stockQuantity) {
            Book book1 = new Book();
